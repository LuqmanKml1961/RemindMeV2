...
export function BottomNav() {
  ...
  return (
    <>
      ...
      <nav
        aria-label="Primary"
        className="fixed inset-x-4 bottom-[max(calc(env(safe-area-inset-bottom)+12px),24px)] z-40 rounded-2xl border bg-card/95 backdrop-blur-md px-2 pt-[7px] pb-2 shadow-xl lg:hidden"
      >
